...
class Track extends Component {
  hexToRgb(hex) {//TODO external lib
  ...
  render() {
    ...
    const SortableItem = SortableElement(({value}) =>{
      return <Slot tid={this.props.tid} slotChanged={this.props.slotChanged.bind(this)} text={value}/>
    });
    ...
    return (
        ...
        <SortableList pressDelay={100} useWindowAsScrollContainer={true} axis="x" slots={this.props.data.slots} onSortEnd={this.onSortEnd} />
